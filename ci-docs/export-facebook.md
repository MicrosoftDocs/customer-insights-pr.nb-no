---
title: Eksporter segmenter til Facebook Ads Manager (forhåndsversjon) (inneholder video)
...
ms.locfileid: "9081633"
---
# <a name="export-segments-to-facebook-ads-manager-preview"></a>Eksporter segmenter til Facebook Ads Manager (forhåndsversjon)
