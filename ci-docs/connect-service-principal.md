---
title: Koble til en Azure Data Lake Storage-konto ved hjelp av en Azure-tjenestekontohaver
...
Dynamics 365 Customer Insights har et alternativ for å koble til en Azure Data Lake Storage-konto ved hjelp av en Azure-tjenestekontohaver i stedet for lagringskontonøkler.

Automatiske verktøy som bruker Azure-tjenester, må ha begrensede tillatelser. I stedet for at programmer skal logges på som en bruker med full rettigheter, tilbyr Azure tjenestekontohavere. Bruk tjenestekontohavere til sikkert å [legge til eller redigere en Common Data Model-mappe som en datakilde](connect-common-data-model.md) eller [opprette eller oppdatere et miljø](create-environment.md).

## <a name="prerequisites"></a>Forutsetning

- Data Lake Storage-kontoen som skal bruke tjenestekontohaveren, må være Gen2. Azure Data Lake Gen1-lagringskontoer støttes ikke.
- Azure Data Lake Storage-kontoen har [hierarkisk navneområde aktivert](/azure/storage/blobs/data-lake-storage-namespace).
- Administratortillatelser for Azure-leieren hvis du må opprette en ny tjenestekontohaver.
...
Før du oppretter en ny tjenestekontohaver for Customer Insights, kontrollerer du om den allerede finnes i organisasjonen. I de fleste tilfeller finnes den allerede.
...
5. Hvis du finner en samsvarende oppføring, betyr det at tjenestekontohaveren allerede finnes. [Gi tillatelser](#grant-permissions-to-the-service-principal-to-access-the-storage-account) til tjenestekontohaveren for tilgang til lagringskontoen.
...
6. Hvis ingen resultater returneres, [oppretter du en ny tjenestekontohaver](#create-a-new-service-principal).
...
For å kunne gi tillatelser til tjenestekontohaveren for lagringskontoen du vil bruke i Customer Insights, må en av følgende roller tilordnes til lagringskontoen eller beholderen:

|Legitimasjon|Forutsetninger|
|----------|------------|
|Nåværende påloggede bruker|**Rolle**: Storage Blob-dataleser, Storage Blob-bidragsyter eller Storage Blob-eier.<br>**Nivå**: Tillatelser gitt på lagringskontoen eller beholderen.</br>|
|Customer Insights-tjenestekontohaver –<br>Bruk av Azure Data Lake Storage som en datakilde</br>|Alternativ 1<ul><li>**Rolle**: Storage Blob-dataleser, Storage Blob-databidragsyter eller Storage Blob-dataeier.</li><li>**Nivå**: Tillatelser gitt på lagringskontoen.</li></ul>Alternativ 2 *(uten å dele tjenestekontohavertilgang til lagringskontoen)*<ul><li>**Rolle 1**: Storage Blob-dataleser, Storage Blob-databidragsyter eller Storage Blob-dataeier.</li><li>**Nivå**: Tillatelser gitt på beholderen.</li><li>**Rolle 2**: Storage Blob-datadelegerer.</li><li>**Nivå**: Tillatelser gitt på lagringskontoen.</li></ul>|
|Customer Insights-tjenestekontohaver – <br>Bruk av Azure Data Lake Storage som utdata eller mål</br>|Alternativ 1<ul><li>**Rolle**: Storage Blob-databidragsyter eller Storage Blob-eier.</li><li>**Nivå**: Tillatelser gitt på lagringskontoen.</li></ul>Alternativ 2 *(uten å dele tjenestekontohavertilgang til lagringskontoen)*<ul><li>**Rolle**: Storage Blob-databidragsyter eller Storage Blob-eier.</li><li>**Nivå**: Tillatelser gitt på beholderen.</li><li>**Rolle 2**: Storage Blob-delegerer.</li><li>**Nivå**: Tillatelser gitt på lagringskontoen.</li></ul>|
...
Legg ved en Data Lake Storage-konto i Customer Insights for å [lagre utdata](manage-environments.md) eller [bruke den som en datakilde](connect-dataverse-managed-lake.md). Velg mellom en [ressursbasert](#resource-based-storage-account-connection) eller en [abonnementsbasert](#subscription-based-storage-account-connection) metode, og følge disse trinnene.
