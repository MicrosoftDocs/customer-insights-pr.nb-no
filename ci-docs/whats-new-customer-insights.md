...
## <a name="september-2022-updates"></a>September 2022-oppdateringer

Oppdateringene i september 2022 inkluderer nye funksjoner, ytelsesoppgraderinger og feilrettinger.

### <a name="export-data-to-hubspot"></a>Eksportere data til HubSpot

Eksporter segmenter av enhetlige kundeprofiler til HubSpot, og bruk dem for e-postmarkedsføring.

Hvis du vil ha mer informasjon, kan du se [Eksportere segmenter til HubSpot](export-hubspot.md).

### <a name="remove-a-unified-field-or-entity-from-data-unification"></a>Fjerne et enhetlig felt eller en enhet fra en datasamling

Du kan fjerne felter og enheter fra datasamlingsprosessen.

For mer informasjon, se [Fjerne et enhetlig felt](data-unification-update.md#remove-a-unified-field).

### <a name="manage-unknown-customer-profiles"></a>Behandle ukjente kundeprofiler

Tilpassing av innhold avhenger av at kundedataene er omfattende og fullstendige, og Customer Insights hjelper deg med å nå disse målene. Du kan administrere kundeprofiler for brukere som du ikke har annen informasjon enn en ID for.

Hvis du vil ha mer informasjon, kan du se [Behandle ukjente profiler med Customer Insights](manage-unknown-profiles.md).
